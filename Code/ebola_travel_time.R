...
# ariwara_zone <- shapefile('Data/ariwara.shp') #ariwara case >42 days ago
# uga_parish <- shapefile('Data/Uganda_parish_crop.shp')
# mwenga <- shapefile('Data/mwenga.shp') mwenga case >42 days ago
# mwenga$nov19_new <- 1
...
# 
# 
# custom_areas <- shapefile('Data/custom_health_areas.shp') #custom made shapefiles to define Lolwa and Salama
# 
# health_areas <- bind(health_areas, custom_areas, mwenga)
ha_infect <- health_areas[which(health_areas@data$nov19_new == 1),]
...
writeRaster(access.raster, filename = 'Outputs_Nov19_update/access_raster_raw.tif', overwrite = TRUE)
...
writeRaster(access.raster, filename = 'Outputs_Nov19_update/access_raster_hours.tif', overwrite = TRUE)
...
# To save plots use
ggsave(trav_time_plot, filename = 'Outputs_Nov19_update/Travel_time_map.png', width = 8, height = 8)
ggsave(rw_plot, filename = 'Outputs_Nov19_update/Rwanda_map.png', width = 8, height = 8)
ggsave(ug_plot, filename = 'Outputs_Nov19_update/Uganda_map.png', width = 8, height = 8)
ggsave(sd_plot, filename = 'Outputs_Nov19_update/SSudan_map.png', width = 8, height = 8)
...
# Save to csv
write.csv(hospitals, file = file('Outputs_Nov19_update/hospital_tt.csv', encoding = 'UTF-8'))
write.csv(drc_hosp_tt, file = file('Outputs_Nov19_update/drc_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(rw_hosp_tt, file = file('Outputs_Nov19_update/rw_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(ug_hosp_tt, file = file('Outputs_Nov19_update/ug_hosp_tt.csv', encoding = 'UTF-8'))
write.csv(ss_hosp_tt, file = file('Outputs_Nov19_update/ss_hosp_tt.csv', encoding = 'UTF-8'))
...
ggsave(drc_tab, filename = 'Outputs_Nov19_update/drc_hosp_tt_prettytab.png', height = 8, width = 6)
ggsave(rw_tab, filename = 'Outputs_Nov19_update/rw_hosp_tt_prettytab.png', height = 8, width = 6)
ggsave(ug_tab, filename = 'Outputs_Nov19_update/ug_hosp_tt_prettytab.png', height = 8, width = 6)
ggsave(ss_tab, filename = 'Outputs_Nov19_update/ss_hosp_tt_prettytab.png', height = 8, width = 6)
